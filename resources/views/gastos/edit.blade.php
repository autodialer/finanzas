            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="monto" class="form-control" value="{{ old('monto', $gasto->monto) }}">
                    </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="negocio_id" class="form-select">
                        ...
                        <option value="{{ $negocio->id }}" {{ old('negocio_id', $gasto->negocio_id) == $negocio->id ? 'selected' : '' }}>
                            {{ $negocio->nombre }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="area_id" class="form-select">
                        ...
                        <option value="{{ $area->id }}" {{ old('area_id', $gasto->area_id) == $area->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="cuenta_id" class="form-select">
                        ...
                        <option value="{{ $cuenta->id }}" {{ old('cuenta_id', $gasto->cuenta_id) == $cuenta->id ? 'selected' : '' }}>
