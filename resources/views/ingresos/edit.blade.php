            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="monto" id="monto" class="form-control"
                               value="{{ old('monto', $ingreso->monto) }}" oninput="actualizarIva()">
                    </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="negocio_id" class="form-select">
                        ...
                        <option value="{{ $negocio->id }}" {{ old('negocio_id', $ingreso->negocio_id) == $negocio->id ? 'selected' : '' }}>{{ $negocio->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="area_id" class="form-select">
                        ...
                        <option value="{{ $area->id }}" {{ old('area_id', $ingreso->area_id) == $area->id ? 'selected' : '' }}>{{ $area->negocio->nombre }} — {{ $area->nombre }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select name="categoria_id" class="form-select">
                        ...
                        <option value="{{ $categoria->id }}" {{ old('categoria_id', $ingreso->categoria_id) == $categoria->id ? 'selected' : '' }}>{{ $categoria->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="cliente_id" class="form-select">
                        ...
                        <option value="{{ $cliente->id }}" {{ old('cliente_id', $ingreso->cliente_id) == $cliente->id ? 'selected' : '' }}>{{ $cliente->nombre }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select name="cuenta_id" class="form-select">
                        ...
                        <option value="{{ $cuenta->id }}" {{ old('cuenta_id', $ingreso->cuenta_id) == $cuenta->id ? 'selected' : '' }}>{{ $cuenta->negocio->nombre }} — {{ $cuenta->nombre }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="forma_pago" id="forma_pago" class="form-select" onchange="manejarFormaPago()">
                        ...
                        <option value="tarjeta" {{ old('forma_pago', $ingreso->forma_pago) == 'tarjeta' ? 'selected' : '' }}>Tarjeta</option>
                    </select>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" name="concepto" class="form-control" value="{{ old('concepto', $ingreso->concepto) }}">
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="notas" class="form-control" rows="2">{{ old('notas', $ingreso->notas) }}</textarea>
                </div>
            </div>
